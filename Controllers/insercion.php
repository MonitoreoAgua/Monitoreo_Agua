  ...
  case 'guardarDoc':
    try {
      ...
      if($indice === 'holandes'){
        ...
        $Oblig = array();
        $Oblig['Porcentaje O2'] = $PO2 ;
        $Oblig['DBO'] = $DBO;
        $Oblig['NH4'] = $NH4;
        $documento['Obligatorios'] = $Oblig;
        //Datos opcionales de otros kits.      
        $Opcio['CF'] = validarDato($_POST['cfO']);
        $Opcio['pH'] = validarDato($_POST['phO']);
        $Opcio['Fosfato'] = validarDato($_POST['fosfatoO']);
        $Opcio['Nitrato'] = validarDato($_POST['nitratoO']);
        $Opcio['t'] = validarDato($_POST['t']);
        $Opcio['turbidez'] = validarDato($_POST['turbidezO']);
        $Opcio['Sólidos totales'] = validarDato($_POST['solTotO']);     
      }elseif ($indice === 'NSF') {
        ...
        $Oblig['DBO'] = $DBO;
        $Oblig['pH'] = $pH;
        $Oblig['Fosfato'] = $Fosfato;
        $Oblig['Nitrato'] = $Nitrato;
        $Oblig['t'] = $T;
        $Oblig['turbidez'] = $turbidez;
        $Oblig['Sólidos totales'] = $solTot;
        $documento['Obligatorios'] = $Oblig;
        //Datos opcionales de otros kits.
        $Opcio['NH4'] = validarDato($_POST['nh4O']);
      }else{
        $documento['Indice'] = $indice;
      }
