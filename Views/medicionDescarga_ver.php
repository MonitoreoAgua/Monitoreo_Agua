   ...
   <body>
      ...
      <div class="container-fluid">
         ...
         <?php if($datosAforo['cantidad']==0):?>
            <?=$datosAforo['cantidad']==0?"<h2> <span class=\"badge badge-warning\"><a style='text-decoration: none;' href='/index.php/medicionDescarga?accion=insertar&user=".$_GET['user']."'>No hay datos para mostrar, clic para insertar.</a></span></h2>":""?>
         <?php else:?>
         <div class="text-right"><button class="btn btn-primary" onclick="window.location.href='/index.php/medicionDescarga?accion=insertar&user=<?=$_GET['user'];?>'">Insertar Aforo</button></div>
            <form class="form-horizontal" >
               ...
               <fieldset>
                  <!-- Form Name -->
                  <legend style="border-bottom: 1px solid #e5e5e5; margin-bottom: 20px;">Ver Aforo </legend>
                  <!-- Text input-->
                  <div class="form-group row" style="margin-left: 25%">
                     <label class="col-md-4 col-form-label" for="Ubicacion">Latitud</label>  
                     <div class="col-md-4">
                        <input id="latitud" name="latitud" type="text" class="form-control" disabled="disabled" value="<?=$datosAforo['latitud']?>">
                     </div>
                  </div>
                  <div class="form-group row" style="margin-left: 25%">
