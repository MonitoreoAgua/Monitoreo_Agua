<?php
//interDir se utiliza para cuando el proyecto no está en la raíz.
$interDir='';
//$interDir='/Proyectos/Web-Projects-Importants/Monitoreo_Agua_Web';//Para compu Johan
require $_SERVER['DOCUMENT_ROOT'].$interDir.'/vendor/autoload.php';
